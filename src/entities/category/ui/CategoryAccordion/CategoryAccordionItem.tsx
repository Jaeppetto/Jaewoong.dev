    ...
    <ul>
      {posts?.map(post => (
        <li key={post.id}>
          <Button
            variant="link"
            className="flex w-full items-center justify-start gap-2 bg-transparent px-[1rem] text-[1.2rem] font-normal leading-[1.6rem] transition-all hover:font-bold hover:no-underline"
            onClick={() => {
              navigate({
